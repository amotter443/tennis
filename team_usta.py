...
URL = "https://m.tennislink.usta.com/statsandstandings/"
page = requests.get(URL)
soup = BeautifulSoup(page.content, "html.parser")

#Select the players table
results_list = [table for table in soup.find_all("table", class_="CommonTable Segmented last")]

#Create list of players names
td_list = [table.find_all("td", class_="top") for table in results_list]
a_list = [td.find_all("a") for td in td_list[1]]
